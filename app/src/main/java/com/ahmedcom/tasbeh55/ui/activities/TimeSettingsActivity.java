...
public class TimeSettingsActivity extends AppCompatActivity implements HasBack, View.OnClickListener, CompoundButton.OnCheckedChangeListener, ViewTimeSettings {
      ...
      everyTimeIndex = 0;
       everyTimeTxt = "1 دقيقة";
        ...
        if(timeToPickerDialog == null)
         ...
         bitmap = BitmapFactory.decodeResource(getApplicationContext().getResources() , R.drawable.left_arrow);
        new ActionBarView(this, getString(R.string.times_of_azcar), bitmap, new BackPressedCallingBack(this));
    ...
    public void navigateTolistAzcar(){
      Intent intent = new Intent(getApplicationContext(), ListAzcarActivity.class);
      startActivity(intent);
    }
